...
public struct Styles {
    ...
    public static let barChartStyleNeonBlue = ChartStyle(
        lightModeStyle: barChartStyleNeonBlueLight,
        darkModeStyle: barChartStyleNeonBlueDark
    )
...
public class ChartStyle {
    ...
    convenience public init(lightModeStyle: ChartStyle, darkModeStyle: ChartStyle) {
        self.init(
            backgroundColor: lightModeStyle.backgroundColor,
            accentColor: lightModeStyle.accentColor,
            gradientColor: lightModeStyle.gradientColor,
            textColor: lightModeStyle.textColor,
            legendTextColor: lightModeStyle.legendTextColor,
            dropShadowColor: lightModeStyle.dropShadowColor
        )
